...
<#escape x as x?html>
  ...
  <#if (errorMessage?has_content || errorMessageList?has_content)>
    <div id="content-messages" class="content-messages errorMessage alert alert-block alert-error" onclick="document.getElementById('content-messages').parentNode.removeChild(this)">
  ...
  <#if (eventMessage?has_content || eventMessageList?has_content)>
    <div id="content-messages" class="content-messages eventMessage alert alert-block alert-error" onclick="document.getElementById('content-messages').parentNode.removeChild(this)">
