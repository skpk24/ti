        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<@ofbizUrl>school</@ofbizUrl>?partyId=${userLogin.externalAuthId?if_exists}"><i class="fa fa-users fa-fw"></i> Create Teacher </a>
                    </li>
                    <li>
                        <a href="<@ofbizUrl>teachers</@ofbizUrl>?partyId=${userLogin.externalAuthId?if_exists}"><i class="fa fa-user fa-fw"></i> Create Student </a>
                    </li>
                    <li>
