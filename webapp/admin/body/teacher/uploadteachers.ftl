<div id="page-wrapper">
	<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
            	<a href="<@ofbizUrl>teachers</@ofbizUrl>?partyId=${parameters.partyId?if_exists}">
	...
	<div class="row">
		<div class="panel-body">
			<form role="form" enctype="multipart/form-data" method="post"  action="<@ofbizUrl>uploadBulkTeachers?partyId=${parameters.partyId?if_exists}</@ofbizUrl>" name="uploadTeacherForm" id="uploadTeacherForm">
			 <div class="row">
			  <div class="col-lg-12">
